...
class CAR:
  ...
  VOLT_CC = "CHEVROLET VOLT PREMIER 2016"
  #####End from opgm-build
...
CAR_INFO: Dict[str, Union[GMCarInfo, List[GMCarInfo]]] = {
  ...
  #####Begin from opgm-build
  CAR.VOLT_CC: GMCarInfo("Chevrolet Volt Premier 2016", min_enable_speed=0, video_link="https://youtu.be/QeMCN_4TFfQ"),
  #####End from opgm-build
...
CAMERA_ACC_CAR = {CAR.VOLT_CC, CAR.BOLT_EUV, CAR.SILVERADO, CAR.EQUINOX, CAR.TRAILBLAZER}
